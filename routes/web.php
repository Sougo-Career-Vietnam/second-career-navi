...
//content pages
Route::get('/data', [ContentController::class, 'show'])->defaults('path', 'data')->name('data');
Route::get('/members', [ContentController::class, 'show'])->defaults('path', 'members')->name('members');
...
Route::get('/jobs', [ContentController::class, 'show'])->defaults('path', 'jobs')->name('jobs');
Route::get('/flow', [ContentController::class, 'show'])->defaults('path', 'flow')->name('flow');
Route::get('/feature', [ContentController::class, 'show'])->defaults('path', 'feature')->name('feature');
Route::get('/message', [ContentController::class, 'show'])->defaults('path', 'message')->name('message');
