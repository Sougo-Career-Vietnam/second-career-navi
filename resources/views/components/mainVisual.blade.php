...
<div id="mvSlider">
    ...
    <div class="note-banner">
        <picture>
            <source media="(max-width: 767px)" srcset="{{asset('images/mvSlider/banner_note_sp.png')}}">
            <source media="(min-width: 768px)" srcset="{{asset('images/mvSlider/banner_note_pc.png')}}">
            <img class="" src="{{asset('images/mvSlider/banner_note_pc.png')}}" alt="">
        </picture>
    </div>
