...
{{--                            <img src="{{$imgSrc ?? ''}}" alt="{{$frontendSettings['footer']['corpInfo']['text'] ?? $corporations[0]['corpFullName'] ?? ''}}">--}}
                ...
                <small class="copymobi">株式会社東京デザインアーツ <br>(キャムコムグループ)</small>
                </div>
                @endif
                ...
                <p class="copyright">
                    ...
                    <small class="copyone">株式会社東京デザインアーツ <br>(キャムコムグループ)</small>
                    <small class="copytwo">Copyright ©Tokyo Design ARTS, Inc.</small>
                </p>
